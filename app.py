...
# load files===========================================================================================================
trending_products = pd.read_csv(r"models\trending_products.csv")
train_data = pd.read_csv(r"models\clean_data.csv")
...
def content_based_recommendations(train_data, item_name, top_n=10):
    ...
    recommended_items_details = train_data.iloc[recommended_item_indices][['Name','Rating','ReviewCount','Brand','ImageURL']]
